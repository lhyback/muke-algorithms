...
public class SelectionSortGeneric {
	...
	public static void main(String[] args) {
		...
		//functional program
		Student[] ans = SelectionSortGeneric.sort(arrStudent, (x, y) -> {
